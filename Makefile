#############################################################################
# Makefile for building: CoMP_QPSK_INV_3
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Apr 14 16:23:41 2014
# Project:  CoMP_QPSK_INV_3.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.8.1/bin/qmake -spec /usr/local/Trolltech/Qt-4.8.1/mkspecs/linux-g++ -o Makefile CoMP_QPSK_INV_3.pro
#############################################################################
...
DIST          = /usr/local/Trolltech/Qt-4.8.1/mkspecs/common/unix.conf \
		...
		CoMP_QPSK_INV_3.pro
QMAKE_TARGET  = CoMP_QPSK_INV_3
DESTDIR       = 
TARGET        = CoMP_QPSK_INV_3
...
Makefile: CoMP_QPSK_INV_3.pro  /usr/local/Trolltech/Qt-4.8.1/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.1/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.1/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.1/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.1/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.1/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/local/Trolltech/Qt-4.8.1/mkspecs/linux-g++ -o Makefile CoMP_QPSK_INV_3.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/CoMP_QPSK_INV_31.0.0 || $(MKDIR) .tmp/CoMP_QPSK_INV_31.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CoMP_QPSK_INV_31.0.0/ && $(COPY_FILE) --parents qpsk3.h .tmp/CoMP_QPSK_INV_31.0.0/ && $(COPY_FILE) --parents main.cpp qpsk3.cpp .tmp/CoMP_QPSK_INV_31.0.0/ && $(COPY_FILE) --parents qpsk3.ui .tmp/CoMP_QPSK_INV_31.0.0/ && (cd `dirname .tmp/CoMP_QPSK_INV_31.0.0` && $(TAR) CoMP_QPSK_INV_31.0.0.tar CoMP_QPSK_INV_31.0.0 && $(COMPRESS) CoMP_QPSK_INV_31.0.0.tar) && $(MOVE) `dirname .tmp/CoMP_QPSK_INV_31.0.0`/CoMP_QPSK_INV_31.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CoMP_QPSK_INV_31.0.0
